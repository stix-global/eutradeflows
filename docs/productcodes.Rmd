...
# number of rows
res <- RMySQL::dbSendQuery(con, "SELECT COUNT(*) as nrow FROM vld_comext_product")
...
outputfields <- RMySQL::dbListFields(con,"vld_comext_product")
...
cn <- read.delim("../tradeharvester/data-raw/comext/201707/text/english/CN.txt",
                 header = FALSE,
...
# Product codes IMM
See data-raw/produc_classifications.R to see where the IMM product classification is loaded.
